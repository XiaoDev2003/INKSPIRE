...
const VisitorPopup = () => {
  ...
  return (
    <div
      className={`absolute top-4 right-4 z-50 hidden md:flex items-center rounded-2xl bg-amber-100 px-4 py-2 shadow-lg transition-all duration-500 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-10 opacity-0"} ${isAnimating ? "scale-105" : "scale-100"} ${isFading ? "opacity-80" : "opacity-100"}`}
